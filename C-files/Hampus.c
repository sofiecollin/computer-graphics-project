...
void init(void)
{
	...
	LoadTGATextureSimple("../Textures/SkyBox512.tga", &texSkybox);
...
void display(void)
{
	...
	DrawModel(skybox, prog_skybox, "in_Position", "in_Normal", "in_TexCoord");
	glEnable(GL_DEPTH_TEST);
...
{
	// Light1
	light1.color = (vec3){0.0, 0.0, 0.0};
	light1.isDirectional = 0;
	light1.dir_pos = (vec3){0.0, -3.0, 0.0};
	...
	int nrLights = 5;
	LS list[160] = {candle1, candle2, light3, light4, fire, fire, fire};
